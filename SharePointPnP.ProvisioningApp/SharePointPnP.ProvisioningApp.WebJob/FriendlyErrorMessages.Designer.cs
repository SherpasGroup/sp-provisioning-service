...
namespace SharePointPnP.ProvisioningApp.WebJob {
    ...
    internal class FriendlyErrorMessages {
        ...
        internal FriendlyErrorMessages() {
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Unfortunately there was an exception while executing the provisioning of the requested template. Please try again later..
        /// </summary>
        internal static string Key_Vault_Throttling {
            get {
                return ResourceManager.GetString("Key_Vault_Throttling", resourceCulture);
            }
        }
